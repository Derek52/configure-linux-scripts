"I made this using this website http://bytefluent.com/vivify
"I like this scheme. It needs some tweaking, but this is what I plan to evolve into my "perfect" scheme
set background=dark
if version > 580
	hi clear
	if exists("syntax_on")
...
set t_Co=256
let g:colors_name = "red_brown"

"hi CTagsMember -- no settings --
"hi CTagsGlobalConstant -- no settings --
"hi Ignore -- no settings --
hi Normal guifg=#fe4d97 guibg=#251f1e guisp=#251f1e gui=NONE ctermfg=205 ctermbg=235 cterm=NONE
...
hi Statement guifg=#dbbac9 guibg=NONE guisp=NONE gui=bold ctermfg=181 ctermbg=NONE cterm=bold
...
hi Number guifg=#916637 guibg=NONE guisp=NONE gui=NONE ctermfg=137 ctermbg=NONE cterm=NONE
...
hi Function guifg=#ff3b42 guibg=NONE guisp=NONE gui=bold ctermfg=13 ctermbg=NONE cterm=bold
